...
class PhishingEmailDetector:
    ...
    def prepare_data(self, emails, labels=None):
        ...
        # Scale handcrafted features to [0, 1] range (no negative values for MultinomialNB)
        if labels is not None:
    ...
    def predict(self, email):
        ...
        results = {
            'is_phishing': bool(ensemble_pred[1] > 0.5),  # Convert to Python bool
...
def generate_training_data():
    ...
    # Phishing emails - more diverse examples
    phishing_emails = [
    ...
    # Safe emails - legitimate communications
    safe_emails = [
        ...
        # System notifications (legitimate)
