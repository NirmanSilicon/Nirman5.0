 ...
 * Three variants: 'split' (default), 'center', 'feature'.
 * Features:
 * - Greenery-themed gradient and particle animations.
 * - Full page structure: Hero, How It Works, Testimonials, Final CTA.
 * * Usage: <Landing onGetStarted={() => { console.log('Starting scan!'); }} />
 */

export default function Landing({ onGetStarted = () => {}, variant = "split" }) {
    // We render the full page structure regardless of the hero variant chosen.
    return (
        <LandingPage onGetStarted={onGetStarted} heroVariant={variant} />
    );
}
            ...
            <div className="max-w-7xl mx-auto w-full px-6 py-24 relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
                        ...
                        {/* Feature pills: Section that was adjusted */}
                    ...
                    <div className="flex items-center justify-center lg:justify-end">
                        ...
                        >
                            ...
                            {/* Placeholder for Scanner Screen (Updated visual placeholder) */}
                            <motion.div 
                                className="rounded-2xl h-64 flex flex-col justify-end p-5 shadow-inner" 
                                {...float}
                                style={{ 
                                    backgroundImage: 'url(https://via.placeholder.com/400x300/10b981/ffffff?text=Leafify+Scan+UI)', // Placeholder URL
    ...
    return (
        <section className="py-24 bg-gradient-to-r from-white via-lime-50 to-emerald-50 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                ...
                {/* Progress bar or additional feature */}
                ...
                <div className="mt-16 grid md:grid-cols-3 gap-10">
                    {steps.map((step, index) => (
                        <motion.div
                            ...
                            // Added hover animation for movement
        ...
        <section className="py-24 bg-gradient-to-tr from-green-500 to-emerald-600 text-white">
            <div className="max-w-4xl mx-auto px-6 text-center">
                ...
                <div className="mt-12 grid grid-cols-3 gap-6 border-t border-white/30 pt-8">
                    {/* Stat component already contains whileHover={{ scale: 1.1 }} */}
...
/* ---------------------------------------------------------------------- */
/* ---------- Helper Components (Minor updates for consistency) ---------- */
/* ---------------------------------------------------------------------- */
