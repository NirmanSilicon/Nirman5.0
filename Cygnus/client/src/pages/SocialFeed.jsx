...
const SocialFeed = () => {
  ...
  const { entries, leaderboard, userVotes, loading, error } = useSelector(
    (state) => state.contest
  );
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
              <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-4 border border-gray-700">
                <div className="text-2xl font-bold text-purple-400">
                  {contestStats.totalEntries}
                </div>
                <div className="text-xs text-gray-400">Entries</div>
              </div>
              <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-4 border border-gray-700">
                <div className="text-2xl font-bold text-pink-400">
                  {contestStats.totalVotes}
                </div>
                <div className="text-xs text-gray-400">Total Votes</div>
              </div>
              <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-4 border border-gray-700">
                <div className="text-2xl font-bold text-cyan-400">
                  {contestStats.daysLeft}
                </div>
          ...
          {activeTab === "contest" && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  {entries.length > 0 ? (
                    entries.map((entry) => {
                      ...
                      return (
                        <div
                          key={entryId}
                          className="bg-gray-800/50 backdrop-blur-md rounded-2xl border border-gray-700 overflow-hidden hover:border-purple-500/50 transition-all duration-300"
                        >
                          {/* Entry Header */}
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="text-center p-4 bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-xl border border-purple-500/30">
                      ...
                      <p className="text-gray-300 text-sm">
                        {formatDate(contestPeriod.startDate)} -{" "}
                        {formatDate(contestPeriod.endDate)}
                      </p>
                    </div>
                ...
                <div className="bg-gray-800/50 backdrop-blur-md rounded-2xl p-6 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300">
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 text-sm mb-4">
                      Get creative ideas and help with your upcycling projects
                    </p>
                    <a
                      href="http://127.0.0.1:5050/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center w-full bg-gradient-to-r from-cyan-600 to-blue-600 text-white py-3 px-4 rounded-xl font-semibold hover:from-cyan-700 hover:to-blue-700 transition-all duration-200 border border-cyan-500/30 hover:border-cyan-500/50 shadow-lg"
                    >
                      <svg
              ...
              <div className="bg-gray-800/50 backdrop-blur-md rounded-2xl border border-gray-700 overflow-hidden">
                <div className="p-6 border-b border-gray-700">
                  ...
                  <p className="text-gray-400 mt-2">
                    Users with the highest total upvotes
                  </p>
                </div>
                    ...
                    {leaderboard.length > 0 ? (
                      leaderboard.map((user, index) => {
                        ...
                        const userAvatar =
                          user.user?.avatar ||
                          user.avatar ||
                          "https://images.pexels.com/photos-774909.jpeg?auto=compress&cs=tinysrgb&w=100";
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mt-2">
              Upload before/after photos (multiple allowed)
            </p>
          </div>
